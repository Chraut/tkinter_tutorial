...
my_img3 = ImageTk.PhotoImage(Image.open("images/cat03.jpg"))
my_img4 = ImageTk.PhotoImage(Image.open("images/cat04.jpg"))
my_img5 = ImageTk.PhotoImage(Image.open("images/cat05.jpg"))
